(function () {
    ...
    window.patchedSetInterval = patchedSetInterval;
    window.patchedClearInterval = patchedClearInterval;
    window.patchedSetTimeout = patchedSetTimeout;
    window.patchedClearTimeout = patchedClearTimeout;
})();
